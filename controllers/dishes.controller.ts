...
import { getAllDishes, getDishById, getSignatureDishes, postAddNewDish, putUpdateDish, deleteDish, putSignatureDishes } from "../handlers/dishes.handler";
...
router.put("/signature-dishes", auth, putSignatureDishes);
